...
<div class="comp-header">
	...
	<div class="comp-links">
		<a href="https://github.com/blancos13/ambar-svelte/blob/main/src/lib/components/Button.svelte" target="_blank" rel="noreferrer" class="comp-link">
...
<section class="doc-section">
	...
	<div class="preview-box">
		<div class="flex flex-wrap items-center gap-3">
			...
			<Button href="https://github.com/blancos13/ambar-svelte" variant="outline" external>GitHub ↗</Button>
		</div>
	</div>
